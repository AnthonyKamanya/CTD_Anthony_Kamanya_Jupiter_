...
const year = today.getFullYear() // picking only the year
const copyright = document.createElement('p'); //create the copyright element
copyright.innerHTML = `<span>&#169 ${year} Anthony</span>` //look inside the HTML to see what's there or put new things inside.
